...
if [ -f "C:/Users/E16/go/bin/moai" ]; then
	exec "C:/Users/E16/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "C:/Users/E16/.local/bin/moai" ]; then
	exec "C:/Users/E16/.local/bin/moai" statusline < "$temp_file"
fi
