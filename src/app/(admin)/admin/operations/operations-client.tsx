...
import {
  HyphenStatusSection,
  type HyphenStatus,
} from "./_components/hyphen-status-section";
import {
  AiStatsSection,
  type AiCallStats,
} from "./_components/ai-stats-section";
import {
  NotificationLogSection,
  type NotificationLogEntry,
} from "./_components/notification-log-section";
import {
  AiTrendSection,
  type AiTrendDay,
} from "./_components/ai-trend-section";

// Re-export for page.tsx (Phase 3.2 — keeps page's imports unchanged)
export type { AiCallStats, HyphenStatus, NotificationLogEntry, AiTrendDay };
...
export function OperationsClient({
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      {/* Section E: Hyphen status (Phase 1.1, extracted in 3.2) */}
      <HyphenStatusSection status={hyphenStatus} />
      ...
      {/* Section C: Notification log (Phase 1.3, extracted in 3.2) */}
      <NotificationLogSection logs={notificationLogs} />

      {/* Section D: AI call stats (Phase 0.6, extracted in 3.2) */}
      <AiStatsSection stats={aiStats} />

      {/* Section F: AI 7-day trend (Phase 3.3 observability) */}
      <AiTrendSection trend={aiTrend} />
...
// Helper components moved to ./_components/stat-cards.tsx (Phase 3.2)
